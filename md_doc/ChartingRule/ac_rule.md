...
![](assets/ac_rule_008.png)     
![](assets/ac_rule_009.png)
...
It means when placing down a <kbd>:ac_t:+:ac_s:</kbd> Multi Note horizontally, it will be placed on the First 2 Markers (starting from the Left).
![](assets/ac_rule_011.png)     
It also means when placing down a <kbd>:ac_x:+:ac_o:</kbd> Multi Note horizontally, it will be placed on the Last 2 Markers (starting from the Left)   
